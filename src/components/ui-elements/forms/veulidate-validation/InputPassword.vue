<template>
  <div class="input-block" :class="{
    ...
    <span class="input-wrap">
      <label :for="id">
        <input :type="(autocompleteEnabled || v$.password.$dirty) && !state.isPasswordVisible ? 'password' : 'text'"
          :id="id" class="input password" v-model="v$.password.$model">
      </label>
      <div class="password-eye-icon" :class="{ 'crossed-out': state.isPasswordVisible }"
